...
Revision ID: 035e23289f48
Revises: 
Create Date: 2019-06-25 18:26:37.668271
...
def upgrade():
    ...
    op.create_table('ih_hourse_info',
    sa.Column('creat_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('hourse_price', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('ih_hourse_image')
    op.drop_table('ih_hourse_facility')
    op.drop_table('ih_hourse_info')
